# -*- encoding: utf-8 -*-
# stub: rails-html-sanitizer 1.7.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/rails/rails-html-sanitizer/issues", "changelog_uri" => "https://github.com/rails/rails-html-sanitizer/blob/v1.7.0/CHANGELOG.md", "documentation_uri" => "https://www.rubydoc.info/gems/rails-html-sanitizer/1.7.0", "source_code_uri" => "https://github.com/rails/rails-html-sanitizer/tree/v1.7.0" } if s.respond_to? :metadata=
  ...
  s.add_runtime_dependency(%q<loofah>.freeze, ["~> 2.25"])
