...
Gem::Specification.new do |s|
  ...
  s.metadata = { "changelog_uri" => "https://github.com/rack/rackup/blob/main/releases.md", "rubygems_mfa_required" => "true", "source_code_uri" => "https://github.com/rack/rackup.git" } if s.respond_to? :metadata=
